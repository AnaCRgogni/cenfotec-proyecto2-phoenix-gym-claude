...
;(function(factory) {
    ...
    EvoCalendar = (function() {
        ...
        function EvoCalendar(element, settings) {
            ...
            _.defaults = {
                theme: null,
                format: 'yyyy-MM-dd', // Cambiado a formato SQL Server
                titleFormat: 'MM yyyy',
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    es: {
                        ...
                        noEventForToday: "No se han registrado horas de disponibilidad para hoy.",
                        noEventForThisDay: "No se han registrado horas de disponibilidad para este día",
            ...
            if(_.options.calendarEvents != null) {
                for(var i=0; i < _.options.calendarEvents.length; i++) {
                    // If event doesn't have an idEvo, throw an error message
                    if (!_.options.calendarEvents[i].idEvo) {
                        console.log("%c Event named: \""+_.options.calendarEvents[i].name+"\" doesn't have a unique idEvo ", "color:white;font-weight:bold;background-color:#e21d1d;");
                    }
    ...
    EvoCalendar.prototype.buildTheBones = function() {
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            // if: _.options.sidebarToggler
            if(_.options.sidebarToggler) {
                $(_.$elements.sidebarEl).append('<span idEvo="sidebarToggler" role="button" aria-pressed title="'+_.initials.dates[_.options.language].closeSidebarText+'"><button class="icon-button"><span class="bars"></span></button></span>');
                if(!_.$elements.sidebarToggler) _.$elements.sidebarToggler = $(_.$elements.sidebarEl).find('span#sidebarToggler');
            }
            if(_.options.eventListToggler) {
                $(_.$elements.calendarEl).append('<span idEvo="eventListToggler" role="button" aria-pressed title="'+_.initials.dates[_.options.language].closeEventListText+'"><button class="icon-button"><span class="chevron-arrow-right"></span></button></span>');
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup = '<div class="event-container" role="button" data-event-index="' + (event_data.idEvo)+'">';
        ...
        _.$elements.eventEl.find('[data-event-index="' + (event_data.idEvo)+'"]')
        .off('click.evocalendar')
        .on('click.evocalendar', _.selectEvent);
    }
    ...
    ****************/
    ...
    EvoCalendar.prototype.selectEvent = function(event) {
        ...
        var idEvo = $(el).data('eventIndex').toString();
        var index = _.options.calendarEvents.map(function (event) { return (event.idEvo).toString() }).indexOf(idEvo);
    ...
    EvoCalendar.prototype.addCalendarEvent = function(arr) {
        ...
        function addEvent(data) {
            if (!data.idEvo) {
                console.log("%c Event named: \"" + data.name +"\" doesn't have a unique idEvo ", "color:white;font-weight:bold;background-color:#e21d1d;");
            }
    ...
    EvoCalendar.prototype.removeCalendarEvent = function(arr) {
        ...
        function deleteEvent(data) {
            // Array index
            var index = _.options.calendarEvents.map(function (event) { return event.idEvo }).indexOf(data);
            ...
            if (index >= 0) {
                ...
                console.log("%c " + data +": IDEvo not found ", "color:white;font-weight:bold;background-color:#e21d1d;");
            }
        }
