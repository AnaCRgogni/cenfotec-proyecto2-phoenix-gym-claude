...
{
    public class HorarioEntrenadorPersonalCrudFactory : CrudFactory
    {
        private HorarioEntrenadorPersonalMapper mapper;

        public HorarioEntrenadorPersonalCrudFactory() : base()
        {
            mapper = new HorarioEntrenadorPersonalMapper();
        ...
        {
            SqlOperation operation = mapper.GetDeleteHorarioEntrenadorPersonalStatement(idEvo);
        ...
        public void UpdateCalendarEventbyIdEvo(HorarioEntrenadorPersonal horarioEntrenadorPersonal)
        {
            SqlOperation operation = mapper.GetUpdateCalendarEventStatement((HorarioEntrenadorPersonal)horarioEntrenadorPersonal);
            dao.ExecuteStoredProcedure(operation);
        }

        public void UpdateCancelCalendarEventbyIdEvo(HorarioEntrenadorPersonal horarioEntrenadorPersonal)
        {
            SqlOperation operation = mapper.GetUpdateCancelCalendarEventStatement((HorarioEntrenadorPersonal)horarioEntrenadorPersonal);
            dao.ExecuteStoredProcedure(operation);
        }
