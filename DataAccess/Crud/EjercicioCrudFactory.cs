...
namespace DataAccess.Crud
{
    public class EjercicioCrudFactory : CrudFactory
    {
        ...
        public override int Create(BaseClass ejercicio)
        {
            SqlOperation operation = mapper.GetCreateStatement(ejercicio);
        ...
        public override int Update(BaseClass ejercicio)
        {
            SqlOperation operation = mapper.GetUpdateStatement(ejercicio);
            return dao.ExecuteStoredProcedure(operation);
        }
