...
{
    public class ViewUsersCrudFactory : CrudFactory
    {
        private ViewUsersMapper mapper;

        public ViewUsersCrudFactory() : base()
        {
            mapper = new ViewUsersMapper();
        ...
        {
            List<T> lstResults = new List<T>();
            List<Dictionary<string, object>> dataResults = dao.ExecuteStoredProcedureWithQuery(mapper.GetRetrieveAllUsersStatement());
