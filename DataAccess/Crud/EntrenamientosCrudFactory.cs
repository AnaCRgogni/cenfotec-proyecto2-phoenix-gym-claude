...
{
    public class EntrenamientosCrudFactory : CrudFactory
    {
        private EntrenamientosMapper mapper;

        public EntrenamientosCrudFactory() : base()
        {
            mapper = new EntrenamientosMapper();
            dao = SqlDao.GetInstance();
        }
        public override int Create(BaseClass entrenamiento)
        {
            SqlOperation operation = mapper.GetCreateStatement(entrenamiento);
