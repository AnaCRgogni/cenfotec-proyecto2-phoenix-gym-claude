...
{
    public class MedicionClienteCrudFactory : CrudFactory
    {
        private MedicionClienteMapper mapper;

        public MedicionClienteCrudFactory() : base()
        {
            mapper = new MedicionClienteMapper();
